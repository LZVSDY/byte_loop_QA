...
BASE_RESULT_DIR = "/data1/lz/loop_QA/result"  # 专业词目录的根路径
SOURCE_TXT_FILE = "/data1/lz/loop_QA/dataset/random_entries.txt"     # 包含原始专业词列表的txt文件路径
FAILURE_LOG_FILE = "/data1/lz/loop_QA/dataset/failure_test.txt"             # 记录失败专业词的文件
OUTPUT_CSV_FILE = "/data1/lz/loop_QA/dataset/qa_report_test.csv"            # 输出的CSV文件名
